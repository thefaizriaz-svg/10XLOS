...
async function bootstrapAuth() {
  try {
    ...
    console.error('LOS indexedDB persistence failed, falling back', e);
    try {
      await setPersistence(auth, browserLocalPersistence);
    } catch (e2) {
      console.error('LOS local persistence failed too \u2014 sessions will not survive closing the app', e2);
    }
  }
